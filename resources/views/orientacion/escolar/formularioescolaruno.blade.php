    ...
    <div class="card-body">
        ...
        <form class="row g-3 mt-3" action="{{ route('escolar.update', $alumnos->id) }}" method="POST">
            ...
            <div class="col-6 mt-3">
                ...
                <input type="text" id="enumerodecelular" name="enumerodecelular" class="form-control" value="{{old('enumerodecelular', $escolar->enumerodecelular)}}" placeholder="Ingrese el lugar de trabajo" maxlength="8"> </input>
