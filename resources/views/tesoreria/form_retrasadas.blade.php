    ...
    <div class="card-body">
        ...
        <form class="row g-3 mt-3" action="{{route('retrasadas.index')}}" method="POST">
            ...
            <div class="col-4 mt-3">
                <input type="text" id="grado" name="grado" class="form-control"  value="{{old('grado')}}" {{ $gradoinput }} placeholder="Ingrese el grado"></input>
            </div>
            ...
            <div class="col-4 mt-3">
                <input type="text" id="anio" name="anio" class="form-control"  value="{{old('anio')}}" {{ $anioinput }} placeholder="Ingrese el año"></input>
            </div>
            ...
            <div class="col-4 mt-3">
                <input type="text" id="materiaretrasada" name="materiaretrasada" class="form-control"  value="{{old('materiaretrasada')}}" {{ $materiaretrasadainput }} placeholder="Ingrese la materia retrasada"></input>
            </div>
            ...
            <div class="col-4 mt-3">
                <input type="text" id="total" name="total" class="form-control" value="{{old('total')}}" {{ $totalinput }} placeholder="Ingrese el total a pagar"></input>
            </div>
